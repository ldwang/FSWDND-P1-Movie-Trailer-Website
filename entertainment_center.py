...
gone_with_the_wind = media.Movie("Gone With the Wind",
                                 "A manipulative Southern belle carries on a "
                                 "turbulent affair with a blockade runner "
...
movies = [gone_with_the_wind, toy_story, the_dark_knight, interstella,
          inception, the_shawshank_redemption]
